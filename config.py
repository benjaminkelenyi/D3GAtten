...
snapshot_arg.add_argument('--snapshot_dir', type=str, default=f'/home/benji/projects/D3Feat.pytorch/data/D3Feat/snapshot/{experiment_id}')
snapshot_arg.add_argument('--tboard_dir', type=str, default=f'/home/benji/projects/D3Feat.pytorch/data/D3Feat/tensorboard/{experiment_id}')
snapshot_arg.add_argument('--snapshot_interval', type=int, default=100)
snapshot_arg.add_argument('--save_dir', type=str, default=os.path.join(f'/home/benji/projects/D3Feat.pytorch/data/D3Feat/snapshot/{experiment_id}', 'models/'))
...
data_arg.add_argument('--root', type=str, default='/home/benji/projects/D3Feat.pytorch/data/3DMatch/')
...
data_arg.add_argument('--augment_noise', type=float, default=0.015)
