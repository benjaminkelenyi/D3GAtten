...
import time
import os
sys.path.append("/home/benji/projects/D3Feat.pytorch/")
...
def deal_with_one_scene(scene, desc_name, timestr, num_keypts):
    ...
    """
    pcdpath = f"/home/benji/projects/D3Feat.pytorch/data/3DMatch/fragments/{scene}/"
    keyptspath = f"/home/benji/projects/D3Feat.pytorch/geometric_registration/{desc_name}{timestr}/keypoints/{scene}"
